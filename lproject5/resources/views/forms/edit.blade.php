    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="form-container">
                ...
                <form form action="{{ route('form.update',['form' => $form]) }}" method="POST" enctype="multipart/form-data">
                    @csrf 
                    @method('put')
                ...
                <input type="file" name="image" id="image" class="form-control-file" value="{{ $form->image }}" >
            </div>
